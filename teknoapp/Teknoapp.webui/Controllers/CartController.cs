...
namespace Teknoapp.webui.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            {
                var orderItem = new Teknoapp.entity.OrderItem()
                {
                    Price = item.Price,
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-99ubTjvrX8snPI7BDQjywzGD5Jh7PBef";
            options.SecretKey = "sandbox-RwRXTk5C92IP1MUokVqsToOjDfulc7Sd";
            options.BaseUrl = "https://sandbox-api.iyzipay.com";

            CreatePaymentRequest request = new CreatePaymentRequest();
            request.Locale = Locale.TR.ToString();
            request.ConversationId = new Random().Next(11111111, 99999999).ToString();
